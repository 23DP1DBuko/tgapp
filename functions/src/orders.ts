      ...
      await db.runTransaction(async (transaction) => {
        ...
        productSnapshots.forEach((productSnapshot, index) => {
          const productData = productSnapshot.data() as
            | { isAvailable?: boolean; price?: number; currency?: string; earlyAccessAt?: string | null; publicAt?: string | null; reservedBy?: number | null; reservedUntil?: FirebaseFirestore.Timestamp | null }
            | undefined
